...
def task_move_histology_files(self,
    center_name = CENTER_NAME,
    pdf_type_name = PDF_TYPE_NAME_HISTOLOGY, #must match available pdf_file from endoreg_db.models.data_file.metadata.pdf_meta.PdfType
    source_directory = DROPOFF_DIR_HISTOLOGY,
